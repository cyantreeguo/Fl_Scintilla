...
//n[fl_unicode2utf((xchar*)lpelf->lfFaceName, l, n)] = 0;
	...
	strcpy(buffer+1, n);
	buffer[0] = ' ';
	Fl::set_font((Fl_Font)(fl_free_font++), strdup(buffer));
...
Fl_Font Fl::set_fonts(const char* xstarname)
{
	if (fl_free_font == FL_FREE_FONT) {// if not already been called
		...
		EnumFontFamilies(fl_gc, NULL, (FONTENUMPROC)enumcbw, xstarname != 0);
...
//  fl_utf2unicode((unsigned char*)s->name+1, l, (xchar*)b);
	...
	b[l] = 0;
	EnumFontFamilies(fl_gc, (WCHAR*)b, (FONTENUMPROC)EnumSizeCb, 0);
	free(b);
