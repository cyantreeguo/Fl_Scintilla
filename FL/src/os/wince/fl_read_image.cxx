              ...
              int   alpha)  	// I - Alpha value for image (0 for none)
{
	...
	BITMAPINFO bmphinfo = {0};
	bmphinfo.bmiHeader.biSize = sizeof(BITMAPINFOHEADER);
	bmphinfo.bmiHeader.biWidth = w;
	bmphinfo.bmiHeader.biHeight = h;
	bmphinfo.bmiHeader.biPlanes  = 1;
	bmphinfo.bmiHeader.biBitCount = 16;
	bmphinfo.bmiHeader.biCompression = BI_RGB;
	hbm = CreateDIBSection(hdc, (BITMAPINFO*)&bmphinfo, DIB_RGB_COLORS, NULL, NULL, NULL);
