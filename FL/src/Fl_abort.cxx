//
// "$Id: Fl_abort.cxx 8864 2011-07-19 04:49:30Z greg.ercolano $"
//
...
static void error(const char *format, ...)
{
	...
	va_end(args);
	MessageBoxA(0,buf,"Error",MB_ICONEXCLAMATION|MB_SYSTEMMODAL);
}
...
static void fatal(const char *format, ...)
{
	...
	vsnprintf(buf, 1024, format, args);
	va_end(args);
	MessageBoxA(0,buf,"Error",MB_ICONSTOP|MB_SYSTEMMODAL);
	::exit(1);
}
...
//
// End of "$Id: Fl_abort.cxx 8864 2011-07-19 04:49:30Z greg.ercolano $".
//
